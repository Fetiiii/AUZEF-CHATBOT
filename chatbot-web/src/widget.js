(function () {
  ...
  style.textContent = [
    ...
    'background:linear-gradient(160deg,#E6CB86,#D0AC59);',
    'box-shadow:inset 0 0 0 1px rgba(255,255,255,.5),0 2px 7px rgba(31,42,24,.28);',
  ...
  wrap.innerHTML =
    ...
    '<div class="popup hidden" id="w-popup">' +
      '<div class="header">' +
        '<div class="avatar">' +
          '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.9" style="color:#354923">' +
