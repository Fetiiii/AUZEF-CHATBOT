...
const TR: Dict = {
  ...
  'system-sign-in-username-text': 'E-posta',
  'system-sign-in-username-box-text': 'E-posta adresiniz',
...
const EN: Dict = {
  ...
  'system-sign-in-username-text': 'Email',
  'system-sign-in-username-box-text': 'Your email address',
